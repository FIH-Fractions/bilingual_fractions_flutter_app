...
final List<LearnSlide> learnSlides = [
  LearnSlide(
    ...
    descEs:
        "Una fracción es una parte de un todo. Es menos que una unidad completa, pero más que cero. Usamos fracciones todo el tiempo en la vida real. ¿Alguna vez has comido la mitad de un chocolate? ¿O notado un cuarto? Ambos son fracciones de una cantidad total: un chocolate entero o un dólar entero.\n\nLas fracciones se parecen un poco a expresiones de división, pero no son problemas para resolver. Son una forma de expresar una cantidad. Como los números, las fracciones indican cuánto tienes de algo.",
  ),
  LearnSlide(
  ...
  LearnSlide(
    ...
    titleEs: "",
    descEs:
        "Lo escribimos así porque la pizza tiene 8 porciones... y estás tomando 1.",
  ),
  LearnSlide(
  ...
  LearnSlide(
    ...
    titleEs: "",
    descEs:
        "También podríamos decir que quedaron 6/8 porciones. Es menos que una pizza, pero más que cero pizzas. Por eso usamos una fracción.",
  ),
  LearnSlide(
    ...
    descEs:
        "Cada fracción tiene dos partes: un número superior y un número inferior. En términos matemáticos, se llaman numerador y denominador. No te preocupes mucho por recordar esos nombres. Mientras recuerdes lo que significa cada número, podrás entender cualquier fracción.",
  ),
  LearnSlide(
    ...
    titleEs: "",
    descEs:
        "El número superior, o numerador, se refiere a cierta cantidad de partes. Nos dice de cuánto hablamos. Y el número inferior, o denominador, indica en cuántas partes se ha dividido el todo.",
  ),
  LearnSlide(
    ...
    descEs:
        "Cuando leemos o hablamos de fracciones, usamos números especiales llamados números ordinales. Una buena forma de recordarlos es que muchos de ellos son los mismos que usas al poner cosas en orden: tercero, cuarto, quinto, etc.\n\nProbablemente ya conoces algunos. Por ejemplo, cuando compartes medio chocolate con tu amigo, ambos están comiendo 1/2 del chocolate.",
  ),
  LearnSlide(
    ...
    titleEs: "",
    descEs:
        "Si tuvieras una pizza con ocho porciones, cada porción sería 1/8 de la pizza. Lo leerías así: un octavo.",
  ),
  LearnSlide(
